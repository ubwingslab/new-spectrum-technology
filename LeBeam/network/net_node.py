...
class dhs(net_node.node):
    ...
    def set_laac(self):
        ...
        #print('laac1', trace_id)
        trace_name = flytera_cfg.lac_trace_name_new[trace_id] 
        trace = flytera_cfg.dhs_new_trace[trace_name]
        #print(flytera_cfg.lac_trace_id)
        #print(flytera_cfg.lac_trace_id[0])
        num_range = int(flytera_cfg.lac_trace_id[0]/10)*10
        #print(num_range)
        random_idx = random.randint(num_range,num_range+9)
        random_idx = flytera_cfg.random_trace[self.ingroup_id-1]   #*********#
        #print('laac2',random_idx)
        #print(trace)
        #print(len(trace))
        
        trace_name_2 = flytera_cfg.lac_trace_name_new[random_idx] 
        trace_2 = flytera_cfg.dhs_new_trace[trace_name_2]
        #print(trace_2)
        #print(len(trace_2))
        
        trace = np.vstack((trace,trace_2))
        #print(trace)
        #print(len(trace))
        #exit()
    ...
    def set_gyr(self):
        ...
        #print(flytera_cfg.gry_trace_id)
        #print(flytera_cfg.gry_trace_id[0])
        num_range = int(flytera_cfg.gry_trace_id[0]/10)*10
        #print(num_range)
        random_idx = random.randint(num_range,num_range+9)
        random_idx = flytera_cfg.random_trace[self.ingroup_id-1]   #*********#
        #print('gyr2', random_idx)
        #print(trace)
        #print(len(trace))
        
        trace_name_2 = flytera_cfg.gry_trace_name_new[random_idx] 
        trace_2 = flytera_cfg.dhs_new_trace[trace_name_2]
        #print(trace_2)
        #print(len(trace_2))
    ...
    def updt_tsmt_wavefront(self):
        ...
        # The wavefront of the transmitter is a circle in xy-plane, centered at (x=0, y=0). The radius can be calculated
