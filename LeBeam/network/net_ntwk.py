...
class net_ntwk_dhs(net_ntwk):
    ...
    def updt_rel_xyz(self):
        ...
        #print('A', xyz_list_tr)
        #print('B', xyz_list_rx)
        if xyz_list_tr not in flytera_cfg.data_tr_xyz:
            flytera_cfg.data_tr_xyz.append(xyz_list_tr)
        if xyz_list_rx not in flytera_cfg.data_rx_xyz:
    ...
    def updt_rel_rpy(self):
        ...
        #print('C', rpy_list_tr)
        #print('D', rpy_list_rx)
        if rpy_list_tr not in flytera_cfg.data_tr_rpy:
            flytera_cfg.data_tr_rpy.append(rpy_list_tr)
        if rpy_list_rx not in flytera_cfg.data_rx_rpy:
    ...
    def operation(self, env):
        ...
        while True:
            ...
            flytera_cfg.data_snr_db.append(snr_db)
            ...
            if flytera_cfg.sim_index == 0:
                ...
                flytera_cfg.data1_norm.append(nmlzd_cap)
            ...
            if flytera_cfg.sim_index == 1:
                ...
                flytera_cfg.data2_norm.append(nmlzd_cap)
            ...
            if flytera_cfg.sim_index == 2:
                flytera_cfg.data3_norm.append(nmlzd_cap)
