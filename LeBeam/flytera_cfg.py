...
sim_tick   = 4000   # the number ticks to simulate
beam_index = 10
...
milli = bw_milli, freq_milli, mol_abs_coeff_milli, tr_pow_milli, ant_gain_milli, boltzmann_const, ref_temp
tera = bw_tera, freq_tera, mol_abs_coeff_tera, tr_pow_tera, ant_gain_tera, boltzmann_const, ref_temp
...
#72_76##15_16##82_85##26_28
#74_78##17_18##84_88##23,26

random_trace = (82, 85)


fig1 = {'gry_trace_id':(41, 45), 'lac_trace_id':(41, 45), 'beam_alignment_itvl':(1, 50, 1000), 'beam_width': 10, 'oper_freq':'tera'}       # micro_outdoor
fig2 = {'gry_trace_id':(71, 75), 'lac_trace_id':(71, 75), 'beam_alignment_itvl':(1, 50, 1000), 'beam_width': 10, 'oper_freq':'tera'}       # small_outdoor
fig3 = {'gry_trace_id':(14, 15), 'lac_trace_id':(14, 15), 'beam_alignment_itvl':(1, 50, 1000), 'beam_width': 10, 'oper_freq':'tera'}       # large_outdoor

fig4 = {'gry_trace_id':(51, 55), 'lac_trace_id':(51, 55), 'beam_alignment_itvl':(1, 50, 1000), 'beam_width': 10, 'oper_freq':'tera'}       # micro_windy
fig5 = {'gry_trace_id':(81, 84), 'lac_trace_id':(81, 84), 'beam_alignment_itvl':(1, 50, 1000), 'beam_width': 10, 'oper_freq':'tera'}       # small_windy
fig6 = {'gry_trace_id':(25, 27), 'lac_trace_id':(25, 27), 'beam_alignment_itvl':(1, 50, 1000), 'beam_width': 10, 'oper_freq':'tera'}       # large_windy

#fig2 = {'gry_trace_id':(71, 75), 'lac_trace_id':(71, 75), 'beam_alignment_itvl':(1, 50, 1000), 'beam_width': 10, 'oper_freq':'milli'}       # small_outdoor
#fig3 = {'gry_trace_id':(14, 15), 'lac_trace_id':(14, 15), 'beam_alignment_itvl':(1, 50, 1000), 'beam_width': 10, 'oper_freq':'milli'}       # large_outdoor

#fig5 = {'gry_trace_id':(81, 84), 'lac_trace_id':(81, 84), 'beam_alignment_itvl':(1, 50, 1000), 'beam_width': 10, 'oper_freq':'milli'}       # small_windy
#fig6 = {'gry_trace_id':(25, 27), 'lac_trace_id':(25, 27), 'beam_alignment_itvl':(1, 50, 1000), 'beam_width': 10, 'oper_freq':'milli'}       # large_windy
