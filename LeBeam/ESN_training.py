...
def ESN_train(data):
    ...
    train_data, train_data_angle = data[0:N], opt_ang_col[0:N]
    test_data, test_data_angle = data[3*N:4*N], opt_ang_col[3*N:4*N]
    ...
    print(pred_test[199]*2*max_angle)
    print(pred_test[599]*2*max_angle)
    print(pred_test[799]*2*max_angle)
