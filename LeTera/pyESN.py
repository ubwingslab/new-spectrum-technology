...
class ESN():
    ...
    def fit(self, inputs, outputs, inspect=False):
        ...
        print('teacher_scaled')
        #print(teachers_scaled)
        #exit(0)
        ...
        print(self.inverse_out_activation(teachers_scaled[transient:, :]).T)
        #print(teachers_scaled[transient:, :])
        #print(self.inverse_out_activation(teachers_scaled[transient:, :]))
        #print(transient)
        ...
        #print('a', extended_states)
        #print('b', self.W_out.T)
