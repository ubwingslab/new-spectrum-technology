...
def plots(nt_obj):
    ...
    # ax.scatter3D(x, y, z2, c='g', marker='o',label='Rate for all users')
    # #ax.plot(x,y,z1, color='r')
    # ax.scatter3D(x, y, z1, c='k', marker='^', label='Rate for users served by moving MBS')
    # #ax.plot(x,y,z2, color='b')
    # ax.set_xlabel('X Coord')
    # ax.set_ylabel('Y Coord')
    # ax.set_zlabel('Rate in Mbps')
    # ax.set_title('MBS moving to next best location (Reinforcement threshold set to non zero value)')
    # plt.legend()
    # plt.show()
