...
# Sabarish: Add lte_bs_mobile,-
lte_bs_mobile = 'lte_bs_mobile'
# Sabarish: Add blockage type here
blk         = 'blk'
lte_ue      = 'lte_ue'
wifi_ap     = 'wifi_ap'
wifi_usr    = 'wifi_usr'
...
node_type_list = [lte_bs, lte_bs_cog, lte_bs_mobile, lte_ue, wifi_ap, wifi_usr, blk]

# Map the node type to the corresponding group 
node2group = {lte_bs:group_bs, lte_bs_cog:group_bs, lte_bs_mobile:group_bs, lte_ue:group_ue, wifi_ap:group_ap, wifi_usr:group_usr, blk: group_blk}
